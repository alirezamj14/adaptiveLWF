...
switch LwF
    case {'Yes'}
        ...
        Yi=Dataset2.X_train;
        Yi_old=Yi;
        Yi_old=mean(std(Yi))*randn(size(Yi));
        %%%%%%%%
        
        
        T_hat_train_old=W(1).Oi*Yi_old;
        W(1).Oi=LS_LwF(Dataset2.T_train, Yi ,Yi_old, W(1).Oi, Parameters.lam_0, Parameters.eta_0_new);
        T_hat_train=W(1).Oi*Yi;
        ...
        while layer<Parameters.L
            ...
            W(layer+1).Oi=LS_LwF(Dataset2.T_train, Yi, Yi_old, W(layer+1).Oi, Parameters.lam_l, Parameters.eta_l_new);
            T_hat_train=W(layer+1).Oi*Yi;
